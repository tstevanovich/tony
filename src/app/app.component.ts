...
export class AppComponent implements OnInit {
  ...
  socialLinks = [
    ...
    { link: 'https://twitter.com/TonyStevanovich', label: 'Twitter', icon: 'fa fa-twitter-square' },
    {
      link: 'https://www.linkedin.com/in/tony-stevanovich-7030b11/',
      label: 'LinkedIn',
      icon: 'fa fa-linkedin-square'
    },
    { link: 'https://github.com/tstevanovich', label: 'Github', icon: 'fa fa-github-square' },
